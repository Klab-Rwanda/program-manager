...
export default function SubmitProjectsPage() {
  ...
  const [projects] = useState<Project[]>([
    ...
    },
    {
      ...
      feedback: "Good job on the mobile app! The user interface is clean and intuitive. The task management features are well implemented, but consider optimizing the performance for larger datasets. Overall, a solid submission.",
      grade: "B",
