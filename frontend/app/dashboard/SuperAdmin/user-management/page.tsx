...
export default function UserManagementPage() {
  ...
  const fetchUsers = useCallback(async () => {
    ...
    try {
      ...
      toast.error(
        err.response?.data?.message || `Failed to fetch ${view} users.`
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Oversee all users in the system.
          </p>
        </div>
        <Button
          onClick={() => handleOpenModal()}
          className='bg-[#1f497d] hover:bg-[#1a3f6b]'
        >
                    ...
                    <TableRow key={user._id}>
                      ...
                      <TableCell className='text-right'>
                        ...
                        <Button
                          variant='ghost'
                          size='icon'
                          onClick={() => openConfirmationDialog('status', user)}
                        ...
                        <Button
                          ...
                          onClick={() => openConfirmationDialog('delete', user)}
                          title='Delete User'
                        >
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {editingUser
                ...
                : 'Add a new user. Their password will be sent via email.'}
            </DialogDescription>
          </DialogHeader>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className='flex items-center gap-2'>
              <AlertTriangle className='text-destructive' /> Are you absolutely
              sure?
            </AlertDialogTitle>
            <AlertDialogDescription>
              {dialogState.type === 'delete'
                ...
                : `This will ${
                    dialogState.user?.isActive ? 'deactivate' : 'reactivate'
                  } the account for "${dialogState.user?.name}".`}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
